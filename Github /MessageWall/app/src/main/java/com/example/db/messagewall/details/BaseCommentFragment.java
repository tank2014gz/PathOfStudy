...
public class BaseCommentFragment extends Fragment {
    ...
    public static BaseCommentFragment newInstance(String param1, String param2) {
        BaseCommentFragment fragment = new BaseCommentFragment();
