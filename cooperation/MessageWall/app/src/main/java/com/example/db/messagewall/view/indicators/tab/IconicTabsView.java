package com.example.db.messagewall.view.indicators.tab;
...
import com.example.db.messagewall.view.indicators.observer.ObservableView;
import com.example.db.messagewall.view.indicators.observer.ViewPagerObserver;
import com.example.db.messagewall.view.indicators.tab.effect.GreyscaleIconicTabsEffect;
import com.example.db.messagewall.view.indicators.tab.effect.IconicTabsEffect;
...
public class IconicTabsView extends HorizontalScrollView implements ObservableView {
    ...
    public IconicTabsView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        float dp48 = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 28, dm);
