package com.haitou.xiaoyoupai.protobuf.helper;
...
import com.haitou.xiaoyoupai.utils.pinyin.PinYin;
    ...
    public static int getJavaMsgType(IMBaseDefine.MsgType msgType){
        switch (msgType){
            ...
            case MSG_TYPE_FRIEND_REQUEST:
                return DBConstant.MSG_TYPE_FRIEND_REQUEST;
            case MSG_TYPE_SINGLE_AUDIO:
