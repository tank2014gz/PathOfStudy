...
import com.haitou.xiaoyoupai.imservice.callback.ListenerQueue;
import com.haitou.xiaoyoupai.imservice.callback.Packetlistener;
import com.haitou.xiaoyoupai.imservice.event.SocketEvent;
import com.haitou.xiaoyoupai.imservice.network.MsgServerHandler;
import com.haitou.xiaoyoupai.imservice.network.SocketThread;
import com.haitou.xiaoyoupai.protobuf.IMBaseDefine;
import com.haitou.xiaoyoupai.protobuf.base.DataBuffer;
import com.haitou.xiaoyoupai.protobuf.base.DefaultHeader;
...
public class IMSocketManager extends IMManager {
    ...
    public void sendRequest(GeneratedMessageLite requset,int sid,int cid,Packetlistener packetlistener){
        ...
        try{
            //组装包头 header
            com.haitou.xiaoyoupai.protobuf.base.Header header = new DefaultHeader(sid, cid);
    ...
    public void packetDispatch(ChannelBuffer channelBuffer){
        ...
        com.haitou.xiaoyoupai.protobuf.base.Header header = new com.haitou.xiaoyoupai.protobuf.base.Header();
