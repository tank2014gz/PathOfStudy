package com.haitou.xiaoyoupai.ui.base;
...
import com.haitou.tools.ScreenTools;
import com.haitou.xiaoyoupai.R;
import com.haitou.xiaoyoupai.ui.activity.SearchActivity;
import com.haitou.xiaoyoupai.utils.Logger;
import com.haitou.xiaoyoupai.ui.widget.SearchEditText;
import com.haitou.xiaoyoupai.ui.widget.TopTabButton;

public abstract class TTBaseFragment extends Fragment {
	protected ImageView topLeftBtn;
	protected ImageView topRightBtn;
	protected ImageView topRightTwoBtn;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		topRightTwoBtn = (ImageView)topContentView.findViewById(R.id.right_two_btn);
		...
		topRightTwoBtn.setVisibility(View.GONE);
	...
	protected void setTopRightTwoButton(int resID) {
		if (resID <= 0) {
			return;
		}

		topRightTwoBtn.setImageResource(resID);
		topRightTwoBtn.setVisibility(View.VISIBLE);
	}

	protected void hideTopRightTwoButton() {
		topRightTwoBtn.setVisibility(View.GONE);
	}
