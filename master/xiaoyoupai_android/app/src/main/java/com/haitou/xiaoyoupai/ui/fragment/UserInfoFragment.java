...
import com.haitou.xiaoyoupai.ui.activity.DetailPortraitActivity;
...
public class UserInfoFragment extends MainFragment {
	...
	private void initBaseProfile() {
       ...
       imageLoader.displayImage(currentUser.getAvatar(),portraitImageView,options);
...
//		});
	...
	private void setStatus(int status){
		...
		TextView sexTextView = (TextView) curView.findViewById(R.id.status);
		if (sexTextView == null) {
			return;
		}
		...
		if (status == DBConstant.GROUP_STATUS_ONLINE) {
	...
	private void setSex(int sex) {
		...
		TextView sexTextView = (TextView) curView.findViewById(R.id.gender);
		if (sexTextView == null) {
			return;
		}
