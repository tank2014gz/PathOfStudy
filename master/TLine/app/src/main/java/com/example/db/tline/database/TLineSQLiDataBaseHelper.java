...
public class TLineSQLiDataBaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME="com.tline.db0";
    public static final int DATABASE_VERSION=1;


    public static String CREATE_TEXTLINE="create table textline (_id integer primary key autoincrement,title varchar(200),content varchar(400),date varchar(100) ) ";
