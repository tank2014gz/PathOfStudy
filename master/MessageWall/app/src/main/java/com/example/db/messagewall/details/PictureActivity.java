...
public class PictureActivity extends BaseActivity implements PictureDetailsFragment.OnFragmentInteractionListener,
                                                             PictureCommitFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleIndicator.setTitleTransformer(new DefaultTitleTransformer(PictureActivity.this));
    }
