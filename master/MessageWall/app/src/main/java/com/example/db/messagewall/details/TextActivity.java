...
public class TextActivity extends BaseActivity implements TextDetailsFragment.OnFragmentInteractionListener,
                                                          TextCommitFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleIndicator.setTitleTransformer(new DefaultTitleTransformer(TextActivity.this));
    }
