...
public class VideoActivity extends BaseActivity implements VideoDetailsFragment.OnFragmentInteractionListener,
                                                           VideoCommitFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoCommitFragment.setArguments(bundle);
        list.add(videoDetailsFragment);
        list.add(videoCommitFragment);
