...
public class FileActivity extends BaseActivity implements FileDetailsFragment.OnFragmentInteractionListener,
                                                          FileCommitFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleIndicator.setTitleTransformer(new DefaultTitleTransformer(FileActivity.this));
