...
public class CoolMaterialDialog extends Dialog {
     ...
     * Default header's background is {@code #37474F}.</br>
     * This overrides previous calls to {@link #setHeaderBackgroundColor(int)} and
     * {@link #setHeaderBackgroundDrawable(Drawable)}
     *
     ...
     * and {@link #setHeaderBackgroundDrawable(Drawable)}.</br>
     ...
     * Header image has no resource nor drawable by default.</br>
     * This overrides previous calls to {@link #setPrimaryHeaderImageDrawable(Drawable)}
     *
     ...
     * method is useful only with {@link #setPrimaryHeaderImageDrawable(Drawable)}
     ...
     * {@link #setPrimaryHeaderImageDrawable(Drawable)} and
     ...
     * You can use this if you want a bigger image in the header, instead of using {@link #setPrimaryHeaderImageDrawable(Drawable)}
     ...
     * By default, mentioned background is a white circle. New background will be shaped as a circle.</br>
     * <p/>
     * This overrides previous calls to {@link #setSecondaryHeaderImageDrawable(Drawable)}
     *
     ...
     * {@link #setSecondaryHeaderImageDrawable(Drawable)}
     *
     ...
     * <p/>
     * This leaves with no effect previous (and future) calls to {@link #setSecondaryHeaderImageDrawable(Drawable)}
     ...
     * @see #setOnPrimaryButtonClickListener(View.OnClickListener, boolean)
     */
     ...
     *
     * @param drawable new primary button's image.
     * @see #setOnSecondaryButtonClickListener(View.OnClickListener, boolean)
     */
    ...
    public static class Builder {
         ...
         * calls to {@link #setHeaderBackgroundDrawable(Drawable)} and
         ...
         * {@link #setHeaderBackgroundDrawable(Drawable)}</br>
         * <p/>
