...
public class SoftWareFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View RootView=inflater.inflate(R.layout.fragment_rule,null);

        staggeredGridView=(GridView)RootView.findViewById(R.id.rule_grid);

        SoftWareAdapter softWareAdapter=new SoftWareAdapter(getActivity());
        staggeredGridView.setAdapter(softWareAdapter);
