...
public class SoftWareItemAdapter extends BaseAdapter{
    ...
    public SoftWareItemAdapter(Context context,ArrayList<SoftWareInfo> softWareInfos){
        super();
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (softWareInfos.get(i).getTitle()!=null){
            viewHolder.name.setText(softWareInfos.get(i).getTitle());
        }else {
            viewHolder.name.setText("未找到内容");
        }
        if(softWareInfos.get(i).getDate()!=null){
            viewHolder.title.setText(softWareInfos.get(i).getDate());
        }else {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(context, SoftWareItemActivity.class);
                Bundle bundle=new Bundle();
                bundle.putString("url",softWareInfos.get(temp).getUrl());
                bundle.putString("name",softWareInfos.get(temp).getTitle());
