...
import com.example.db.slor.adapter.ArticleListViewAdapter;
...
public class BeautifulArticleFragment extends Fragment {
    ...
    public JazzyListView mJazzyListView;

    public FloatingActionButton mFloatingActionButton;

    public volatile List<Article> articles;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        intentFilter.addAction("com.db.slor");
        getActivity().registerReceiver(myBroadCastReceiver,intentFilter);


        mSwipeRefreshLayout=(SwipeRefreshLayout)RootView.findViewById(R.id.article_refreshlayout);

        mJazzyListView=(JazzyListView)RootView.findViewById(R.id.article_listview);
        mJazzyListView.setTransitionEffect(JazzyHelper.TILT);
        ...
        mFloatingActionButton.attachToListView(mJazzyListView, new ScrollDirectionListener() {
            @Override
        ...
        mFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(getActivity(), EditBeautyArtActivity.class);
    ...
    private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            articles = MyService.findTodos();
            Log.v("dbbbbbbbbbbbbb1",String.valueOf(articles.size()));
            return null;
        }
        @Override
        ...
        protected void onPostExecute(Void result) {
            // 展现ListView
            ArticleListViewAdapter adapter = new ArticleListViewAdapter(getActivity(), articles);
